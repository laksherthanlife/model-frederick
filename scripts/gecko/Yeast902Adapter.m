classdef Yeast902Adapter < ModelAdapter 
	methods
		function obj = Yeast902Adapter()
			obj.params.path = getenv('YSTWIN_ECBUILD');

			obj.params.convGEM = fullfile(obj.params.path,'models','yeast-GEM-902.yml');
